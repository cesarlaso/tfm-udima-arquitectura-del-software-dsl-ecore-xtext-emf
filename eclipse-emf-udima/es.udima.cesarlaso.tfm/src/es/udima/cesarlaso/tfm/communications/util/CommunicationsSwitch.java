...
public class CommunicationsSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case CommunicationsPackage.PACKET: {
				Packet packet = (Packet)theEObject;
				T result = casePacket(packet);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CommunicationsPackage.SERVICE: {
				Service service = (Service)theEObject;
				T result = caseService(service);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CommunicationsPackage.SERVICE_REQUEST: {
				ServiceRequest serviceRequest = (ServiceRequest)theEObject;
				T result = caseServiceRequest(serviceRequest);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CommunicationsPackage.SERVICE_RESPONSE: {
				ServiceResponse serviceResponse = (ServiceResponse)theEObject;
				T result = caseServiceResponse(serviceResponse);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CommunicationsPackage.SERVICE_NOTIFICATION: {
				ServiceNotification serviceNotification = (ServiceNotification)theEObject;
				T result = caseServiceNotification(serviceNotification);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
