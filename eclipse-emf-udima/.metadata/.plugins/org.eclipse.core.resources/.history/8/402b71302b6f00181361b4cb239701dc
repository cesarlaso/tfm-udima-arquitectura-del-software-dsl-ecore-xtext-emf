...
public class ProgramsAdapterFactory extends AdapterFactoryImpl {
	...
	protected ProgramsSwitch<Adapter> modelSwitch =
		new ProgramsSwitch<Adapter>() {
			...
			@Override
			public Adapter caseProgramState(ProgramState object) {
				return createProgramStateAdapter();
			}
			@Override
			public Adapter caseChangeStateActuator(ChangeStateActuator object) {
				return createChangeStateActuatorAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link es.udima.cesarlaso.tfm.programs.Program <em>Program</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link es.udima.cesarlaso.tfm.programs.ProgramState <em>Program State</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link es.udima.cesarlaso.tfm.programs.ChangeStateActuator <em>Change State Actuator</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
