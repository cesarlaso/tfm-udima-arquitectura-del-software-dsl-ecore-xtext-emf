...
public class EventsAdapterFactory extends AdapterFactoryImpl {
	...
	protected EventsSwitch<Adapter> modelSwitch =
		new EventsSwitch<Adapter>() {
			...
			@Override
			public Adapter caseSequentialActuators(SequentialActuators object) {
				return createSequentialActuatorsAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link es.udima.cesarlaso.tfm.events.SequentialActuators <em>Sequential Actuators</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 * @return the new adapter.
	 * @see es.udima.cesarlaso.tfm.events.SequentialActuators
	 * @generated
	 */
